# Checklist – Instant View
[![](https://instantview.telegram.org/file/811140890/2/3WnXjPnynwU.52493/709f815bf5f24bff9c "Instant View Platform. Click for hi-res picture")](/file/811140067/3/6oS3A6aSzxU.261217/1d6f75b81ed67c983a)

This page lists [general rules](#general-rules) and [detailed clarifications](#perfect-templates) for creating good Instant View templates for news articles.

For more info on templates, see our [Introduction](https://instantview.telegram.org/) and [Sample Templates](/samples/).

### [](#general-rules)General Rules

Instant View templates must meet these five basic requirements:

#### [](#1-ivs-must-only-be-generated-for-pages-that-need-them)1\. IVs must only be generated for pages that need them
...
#### [](#2-all-essential-content-must-be-preserved)2\. All essential content must be preserved
...
#### [](#3-unnecessary-elements-must-be-removed)3\. Unnecessary elements must be removed
...
#### [](#4-template-must-process-all-the-pages-it-covers)4\. Template must process all the pages it covers
...
#### [](#5-no-extraneous-info-may-be-added)5\. No extraneous info may be added
...
> More detailed [criteria and clarifications](#perfect-templates) are available below.
...
When ready, simply tap **Submit Template** next to a template in the [My Templates](https://instantview.telegram.org/my) section:

[![](https://instantview.telegram.org/file/811140021/2/zZEvkMN8bHI.15429/e7369f84b0e449b2ad "Submit button")](/file/811140021/2/zZEvkMN8bHI.15429/e7369f84b0e449b2ad)
...
Click to select and highlight incorrectly parsed blocks in the source page or in the Instant View result and provide a detailed explanation of what is wrong (check the [criteria below](#perfect-templates) for ideas). The author of the template will be able to see all issues, fix and resubmit their work.

* * *

### [](#perfect-templates)Perfect Templates
...
### [](#1-iv-targets-must-generate)1\. IV Targets: Must Generate
...
#### [](#2-2-pages-that-require-significant-interaction)2.2. Pages that require significant interaction
...
#### [](#2-3-pages-featuring-content-not-supported-by-the-iv-format)2.3. Pages featuring content not supported by the IV format

*   Pages with unsupported embedded content that can't be displayed
*   Any other unsupported content

> **Tip:** The rule is simple. If an essential part of an article is not available in the Instant View format, an IV page must **not** be generated. In most cases, this will happen automatically but template creators can further protect their templates from data loss by marking any unsupported essential content using the [@unsupported](about:/docs#unsupported) function. See [this section](#6-4-2-video-audio-from-unsupported-players) for advice on handling unsupported videos.

#### [](#2-4-inaccessible-pages)2.4. Inaccessible pages

*   Pages that are fully or partially behind a paywall.
*   Pages that are only accessible after logging in, etc.

### [](#3-essential-content)3\. Essential Content

All essential content must be presented on the Instant View page.

#### [](#3-1-general-properties)3.1. General properties

*   The title must be shown on the IV page (may need to include the [kicker](#6-1-5-kicker)).
...
> **Important:** See our [**Clarifications**](#6-clarifications) below for tips on how to best process cover images, date and time, author names and URLs, and other tricky elements.

#### [](#3-2-link-preview)3.2. Link preview
...
#### [](#3-3-supported-elements)3.3. Supported elements
...
> **Tip:** Check that pages featuring unsupported content do not generate IV pages. In most cases, this will happen automatically, but it is a good idea to confirm this before submitting your template. Mark any unsupported essential content using the [@unsupported](about:/docs#unsupported) function. See [this section](#6-4-2-video-audio-from-unsupported-players) for advice on handling unsupported videos.

### [](#4-content-to-be-removed)4\. Content to be Removed
...
### [](#5-extraneous-content)5\. Extraneous Content
...
#### [](#6-1-2-date-and-time)6.1.2 Date and time
...
[![](https://instantview.telegram.org/file/811140067/4/sHpKJZGksno.26146/01c22f5990ad752f20 "Subtitle")](/file/811140067/4/sHpKJZGksno.26146/01c22f5990ad752f20)
...
[![](https://instantview.telegram.org/file/811140239/3/NUL4Rsj3By8.33798/35bd1353620089d84c "Summary, standfirst")](/file/811140239/3/NUL4Rsj3By8.33798/35bd1353620089d84c)

A Summary

#### [](#6-1-4-lead-paragraph)6.1.4 Lead paragraph
...
[![](https://instantview.telegram.org/file/811140143/2/4WbpXiI4m8E.64274/a31d87f94d80a60426 "Summary, then lead paragraph in bol")](/file/811140143/2/4WbpXiI4m8E.64274/a31d87f94d80a60426)
...
#### [](#6-1-5-kicker)6.1.5 Kicker

Kickers are separately formatted parts of the title supported in IV 2.0 with the [_kicker_](https://instantview.telegram.org/docs?v=2.0#instant-view-format) property. The kicker property must be set if a kicker is present and its text is actually a part of the title/story (see 'UBER SEX CLAIMS' on the screenshot above).
...
#### [](#6-2-1-image-quality)6.2.1 Image quality
...
See also: **[Infographics](#6-2-6-infographics)**

#### [](#6-2-2-cover-images)6.2.2 Cover images

It is **obligatory** to use a cover image:

*   If the image is **present** on the page and described in the source as “featured-img”, “cover”, “lead\_img”, “main\_image”, etc.
...
#### [](#6-2-3-galleries-and-slideshows)6.2.3 Galleries and slideshows
...
[![](https://instantview.telegram.org/file/811140078/1/ZmgNlv6_TZo.75424/f8e251df3e3d8affe0 "Caption for the slideshow and individual image")](/file/811140078/1/ZmgNlv6_TZo.75424/f8e251df3e3d8affe0)
...
#### [](#6-2-5-media-credits)6.2.5 Media credits
...
#### [](#6-2-6-infographics)6.2.6 Infographics
...
#### [](#6-3-1-image-links)6.3.1 Image links
...
Image links are required only if they are meaningful. If the link opens the same image in a higher resolution, it must be removed. Exception: [Infographics](#6-2-6-infographics).

#### [](#6-3-2-related-articles-and-other-more-links)6.3.2 Related Articles and other “More” links
...
*   Navigational links to the other parts of [multipart articles](#6-3-7-multi-page-articles).
...
#### [](#6-3-2-1-formatting-related-articles)6.3.2.1. Formatting Related Articles
...
#### [](#6-3-3-channel-links)6.3.3 Channel links
...
[![](https://instantview.telegram.org/file/811140053/2/y2z4UVQevzU.36357/2e7481b67386604d59 "Channel link")](/file/811140053/2/y2z4UVQevzU.36357/2e7481b67386604d59)
...
#### [](#6-3-4-source-links)6.3.4 Source links
...
#### [](#6-3-5-author-links)6.3.5 Author links
...
#### [](#6-3-6-social-media-links)6.3.6 Social media links

Sharing buttons and other interface-based links **must be removed** as per [Rule 4](#4-content-to-be-removed).
...
#### [](#6-3-7-multi-page-articles)6.3.7 Multi-page articles

To parse several pages into one IV, update your template to [IV 2.1](about:/docs#options-new) (which skips canonical redirects by default) and use the [inline](about:/docs#inline) function. Make sure to check in-app to see if your solution is working. The IV should open correctly when users share a link to **any** part of the article.
...
**Important:** We will accept issue reports requesting to generate IVs for pages with content previously deemed unsupported if you include a link to a template that fully supports the content in question. This does **not** apply to supporting content from popular widgets that are likely to get official support in the future, see the [list below](#6-4-4-popular-widgets).

#### [](#6-4-1-complex-tables)6.4.1 Complex tables

IV 2.0 includes support for [**Tables**](https://instantview.telegram.org/docs?v=2.0#supported-types). IVs can now be generated for articles with simple tables. However, complex tables may not render through existing means, and must be tagged as [@unsupported](about:/docs/#unsupported).
...
#### [](#6-4-2-video-audio-from-unsupported-players)6.4.2 Video/Audio from unsupported players
...
*   Otherwise, mark the object with the [@unsupported](about:/docs#unsupported) function.
...
#### [](#6-4-3-auxiliary-widgets)6.4.3 Auxiliary widgets
...
#### [](#6-4-4-popular-widgets)6.4.4 Popular Widgets
...
#### [](#6-5-1-subdomains)6.5.1 Subdomains
...
#### [](#6-5-2-service-areas)6.5.2 Service areas
...
#### [](#6-5-3-single-media-pages)6.5.3 Single-media pages
...
If the single-media page contains unsupported media, it must **not** generate an IV. See [6.4.2 Unsupported Video and Audio content](#6-4-2-video-audio-from-unsupported-players).

In all other cases, supporting single-media pages is optional.

#### [](#6-5-4-ancient-lore)6.5.4 Ancient lore
...
### [](#7-checklist-changelog)7\. Checklist Changelog

We will be updating this document with further clarifications as new issues arise.

#### [](#mar-20-2019)Mar 20 2019

> Don’t miss the [IV 2.1](about:/docs#iv-2-1-march-20) update.

**Checklist 2.2:**

**Expanded clarifications**

*   [3.2](#3-2-link-preview), **Link Preview**: `site_name` must include the name that users see on the main page of the website; cover photo must be used in preview if metadata is empty or contains site logo; template must generate proper description if metadata is unsuitable
*   [3.3](#3-3-supported-elements), **Supported Elements**: Credits must be supported in media captions and quotes
*   [6.1.2](#6-1-2-date-and-time), **Date and Time**: Time is optional if the date is set correctly; time zones are optional, unless reliably identifiable in the source
*   [6.2.1](#6-2-1-image-quality), **Image Quality**: for issues to be accepted, the difference in image quality must be significant; higher resolution images must be _reliably_ extractable; note
*   [6.3.1](#6-3-1-image-links), **Image links**: Must be preserved if they are meaningful
*   [6.3.2](#6-3-2-related-articles-and-other-more-links), **Related articles**: Details on when RelatedArticles must not be used; [Formatting guidelines](#6-3-2-1-formatting-related-articles)
*   [6.4](#unsupported-content), **Unsupported content**: Optional to extract content from popular widgets which are scheduled for official Telegram support, even if another template does this
*   [6.4.2](#6-4-2-video-audio-from-unsupported-players), **Unsupported Video/Audio**: Possible to include a link to an audio/video instead of unsupporting an otherwise fine article
*   [6.5.1](#6-5-1-subdomains), **Subdomains**: Added a note on mobile versions

**Added NEW clarifications**

*   [6.2.6](#6-2-6-infographics), **Infographics**
*   [6.3.7](#6-3-7-multi-page-articles), **Multi-page articles**
*   [6.4.3](#6-4-4-popular-widgets), **Popular Widgets**
*   [6.5.2](#6-5-2-service-areas), **Service Areas**
*   [6.5.3](#6-5-3-single-media-pages), **Single-media pages**
*   [6.5.4](#6-5-4-ancient-lore), **Ancient lore**
*   [6.5.5](#6-5-5-quotes), **Quotes**
...
*   [Tables](#6-4-1-complex-tables) are supported (if they are not too complex).
*   Nested lists (and lists inside tables) are supported.
*   [RTL-support](#3-1-general-properties) has been introduced and is obligatory for RTL pages.
*   [Related Articles](#6-3-2-related-articles-and-other-more-links) got a dedicated element (`UPDATED 6.02`, see guidelines!).
*   [Image links](#6-3-1-image-links) are supported.
*   Added guidelines on [image quality](#6-2-1-image-quality).
*   Updated guidelines for [cover images](#6-2-2-cover-images)
*   The new [Icon](#6-2-1-image-quality) type requires careful handling.
*   [Media credits](#6-2-5-media-credits) can be formatted properly (if separable from caption).
*   [Kickers](#6-1-5-kicker) in titles got a dedicated element for certain cases.
*   Added guidelines for supporting [subdomains](#6-5-1-subdomains).
*   Updated guidelines for [social media links](#6-3-6-social-media-links)
*   Updated the guidelines for [site\_name](#3-2-link-preview) in link previews.
